...
// EX: [#email: valid, #lastname: required, #age: range]
//  
function __formSubmitContent(trigger, secs) {
    var button = $(trigger);
    ...
    Ybq.postForm(formSelector,
        function(data) {
            ...
            __formFinalizeAction(button, response, secs);
        },
        function() {
            button.unspin();
            feedbackElement
...
//
function __formFinalizeAction(button, response, secs) {
